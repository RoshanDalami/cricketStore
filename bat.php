...
<body>
    <header>
        ...
        <nav class="nav__links">
            <ul>
                ...
                <li><a class="onsite" href="bat.html">Bat</a></li>
    ...
    <section id="product1" class="section-p2">
        <h2> Bat Collections</h2>
        <div class="pro-container">
            <div class="pro" id="item1">
                <img class="img-2" src="images/bat1.png" alt="">
                <div class="des">
                    <h5 class="title">SS Vintage English Willow Cricket Bat </h5>
                    <h4>₹ 10,999/-</h4>
                </div>
            ...
            <div class="pro">
                <img class="img-2" src="images/bat2.png" alt="">
                <div class="des">
                    <h5>Ton Bat </h5>
                    <h4>₹ 1,799/-</h4>
                </div>
            ...
            <div class="pro">
                <img class="img-2" src="images/bat3.png" alt="">
                <div class="des">
                    <h5>MRF Genius Pink English Willow Cricket Bat </h5>
                    <h4>₹ 9,599/-</h4>
                </div>
                <a href="#"><button class="cart">Add To Cart</button></a>
            </div>
            ...
            <div class="pro">
                <img class="img-2" src="images/bat4.png" alt="">
                <div class="des">
                    <h5>New Balance DC 840 English Willow Cricket Bat </h5>
                    <h4>₹ 17,499/-</h4>
                </div>
                <a href="#"><button class="cart">Add To Cart</button></a>
            </div>
            ...
            <div class="pro">
                <img class="img-2" src="images/bat5.png" alt="">
                <div class="des">
                    <h5>Retro Stunner Kashmir Willow Cricket Bat </h5>
                    <h4>₹ 1,799/-</h4>
                </div>
                <a href="#"><button class="cart">Add To Cart</button></a>
            </div>
            ...
            <div class="pro">
                <img class="img-2" src="images/bat6.png" alt="">
                <div class="des">
                    <h5>Elevar Gully - Kashmir Willow Tennis Bat </h5>
                    <h4>₹ 1,999/-</h4>
                </div>
                <a href="#"><button class="cart">Add To Cart</button></a>
            </div>
            ...
            <div class="pro">
                <img class="img-2" src="images/bat7.png" alt="">
                <div class="des">
                    <h5>Ske New Solid Popular Willow Cricket Bat</h5>
                    <h4>₹ 499/-</h4>
                </div>
                <a href="#"><button class="cart">Add To Cart</button></a>
            </div>
            ...
            <div class="pro">
                <img class="img-2" src="images/bat8.png" alt="">
                <div class="des">
                    <h5>Lycan Junior Cricket Bat</h5>
                    <h4>₹ 299/-</h4>
                </div>
                <a href="#"><button class="cart">Add To Cart</button></a>
            </div>
